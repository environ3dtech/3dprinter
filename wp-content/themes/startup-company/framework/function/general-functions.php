...
/* Register CSS Styles */
function startup_company_register_css_styles() {
	if (!is_admin()) {
		global $post, 
			$wp_styles;
		...
		wp_enqueue_style('startup-company-theme-style', get_template_directory_uri() . '/style.css', array(), '1.0.0', 'screen, print');
		
		wp_enqueue_style('startup-company-style', get_template_directory_uri() . '/theme-framework/theme-style' . CMSMASTERS_THEME_STYLE . '/css/style.css', array(), '1.0.0', 'screen, print');
		
		wp_enqueue_style('startup-company-adaptive', get_template_directory_uri() . '/theme-framework/theme-style' . CMSMASTERS_THEME_STYLE . '/css/adaptive.css', array(), '1.0.0', 'screen, print');
		
		wp_enqueue_style('startup-company-retina', get_template_directory_uri() . '/theme-framework/theme-style' . CMSMASTERS_THEME_STYLE . '/css/retina.css', array(), '1.0.0', 'screen');
		
		
		if (is_rtl()) {
			wp_enqueue_style('startup-company-rtl', get_template_directory_uri() . '/theme-framework/theme-style' . CMSMASTERS_THEME_STYLE . '/css/rtl.css', array(), '1.0.0', 'screen');
		}
		
		
		wp_enqueue_style('startup-company-icons', get_template_directory_uri() . '/css/fontello.css', array(), '1.0.0', 'screen');
		
		wp_enqueue_style('startup-company-icons-custom', get_template_directory_uri() . '/theme-framework/theme-style' . CMSMASTERS_THEME_STYLE . '/css/fontello-custom.css', array(), '1.0.0', 'screen');
		
		wp_enqueue_style('animate', get_template_directory_uri() . '/css/animate.css', array(), '1.0.0', 'screen');
		
		
		// iLightBox skins
		$ilightbox_skin = $cmsmasters_option['startup-company' . '_ilightbox_skin'];
		...
		if (is_dir($style_dir) && get_option('cmsmasters_style_exists_' . 'startup-company')) {
			$cmsmasters_styles_dir = $upload_dir['baseurl'] . '/cmsmasters_styles/';
		}
		
		
		wp_enqueue_style('startup-company-fonts-schemes', $cmsmasters_styles_dir . 'startup-company' . '.css', array(), '1.0.0', 'screen');
	}
}

add_action('wp_enqueue_scripts', 'startup_company_register_css_styles');



/* Register JS Scripts */
function startup_company_register_js_scripts() {
	global $post;
	...
	$cmsmasters_localize_array = array( 
		...
		'project_puzzle_proportion' => 			startup_company_project_puzzle_proportion(), 
		'gmap_api_key' => 						$cmsmasters_option['startup-company' . '_gmap_api_key'], 
		'gmap_api_key_notice' => 				esc_html__('Please add your Google Maps API key', 'startup-company'), 
		'gmap_api_key_notice_link' => 			esc_html__('read more how', 'startup-company'), 
		'primary_color' => 						$cmsmasters_option['startup-company' . '_default_link'], 
		'ilightbox_skin' => 					$cmsmasters_option['startup-company' . '_ilightbox_skin'], 
		'ilightbox_path' => 					$cmsmasters_option['startup-company' . '_ilightbox_path'], 
		'ilightbox_infinite' => 				$cmsmasters_option['startup-company' . '_ilightbox_infinite'], 
		'ilightbox_aspect_ratio' => 			$cmsmasters_option['startup-company' . '_ilightbox_aspect_ratio'], 
		'ilightbox_mobile_optimizer' => 		$cmsmasters_option['startup-company' . '_ilightbox_mobile_optimizer'], 
		'ilightbox_max_scale' => 				$cmsmasters_option['startup-company' . '_ilightbox_max_scale'], 
		'ilightbox_min_scale' => 				$cmsmasters_option['startup-company' . '_ilightbox_min_scale'], 
		'ilightbox_inner_toolbar' => 			$cmsmasters_option['startup-company' . '_ilightbox_inner_toolbar'], 
		'ilightbox_smart_recognition' => 		$cmsmasters_option['startup-company' . '_ilightbox_smart_recognition'], 
		'ilightbox_fullscreen_one_slide' => 	$cmsmasters_option['startup-company' . '_ilightbox_fullscreen_one_slide'], 
		'ilightbox_fullscreen_viewport' => 		$cmsmasters_option['startup-company' . '_ilightbox_fullscreen_viewport'], 
		'ilightbox_controls_toolbar' => 		$cmsmasters_option['startup-company' . '_ilightbox_controls_toolbar'], 
		'ilightbox_controls_arrows' => 			$cmsmasters_option['startup-company' . '_ilightbox_controls_arrows'], 
		'ilightbox_controls_fullscreen' => 		$cmsmasters_option['startup-company' . '_ilightbox_controls_fullscreen'], 
		'ilightbox_controls_thumbnail' => 		$cmsmasters_option['startup-company' . '_ilightbox_controls_thumbnail'], 
		'ilightbox_controls_keyboard' => 		$cmsmasters_option['startup-company' . '_ilightbox_controls_keyboard'], 
		'ilightbox_controls_mousewheel' => 		$cmsmasters_option['startup-company' . '_ilightbox_controls_mousewheel'], 
		'ilightbox_controls_swipe' => 			$cmsmasters_option['startup-company' . '_ilightbox_controls_swipe'], 
		'ilightbox_controls_slideshow' => 		$cmsmasters_option['startup-company' . '_ilightbox_controls_slideshow'], 
		'ilightbox_close_text' => 				esc_html__('Close', 'startup-company'), 
		'ilightbox_enter_fullscreen_text' => 	esc_html__('Enter Fullscreen (Shift+Enter)', 'startup-company'), 
		'ilightbox_exit_fullscreen_text' => 	esc_html__('Exit Fullscreen (Shift+Enter)', 'startup-company'), 
		'ilightbox_slideshow_text' => 			esc_html__('Slideshow', 'startup-company'), 
		'ilightbox_next_text' => 				esc_html__('Next', 'startup-company'), 
		'ilightbox_previous_text' => 			esc_html__('Previous', 'startup-company'), 
		'ilightbox_load_image_error' => 		esc_html__('An error occurred when trying to load photo.', 'startup-company'), 
		'ilightbox_load_contents_error' => 		esc_html__('An error occurred when trying to load contents.', 'startup-company'), 
		'ilightbox_missing_plugin_error' => 	esc_html__("The content your are attempting to view requires the <a href='{pluginspage}' target='_blank'>{type} plugin<\/a>.", 'startup-company') 
	);
	...
	wp_enqueue_script('startup-company-script', get_template_directory_uri() . '/js/jquery.script.js', array('jquery'), '1.0.0', true);
	
	wp_localize_script('startup-company-script', 'cmsmasters_script', $cmsmasters_localize_array);
	
	wp_enqueue_script('startup-company-theme-script', get_template_directory_uri() . '/theme-framework/theme-style' . CMSMASTERS_THEME_STYLE . '/js/jquery.theme-script.js', array('jquery', 'startup-company-script'), '1.0.0', true);
	...
	if ( 
		...
		isset($cmsmasters_option['startup-company' . '_gmap_api_key']) && 
		$cmsmasters_option['startup-company' . '_gmap_api_key'] != '' 
	) {
		wp_enqueue_script('gMapAPI', '//maps.googleapis.com/maps/api/js?key=' . $cmsmasters_option['startup-company' . '_gmap_api_key'], array('jquery'), '1.0.0', true);
	...
	$cmsmasters_custom_js = stripslashes($cmsmasters_option['startup-company' . '_custom_js']);
	
	wp_add_inline_script('startup-company-script', $cmsmasters_custom_js);
	
	
	if (CMSMASTERS_DEVELOPER_MODE) {
		startup_company_regenerate_styles();
	}
}

add_action('wp_enqueue_scripts', 'startup_company_register_js_scripts');



/* Google Fonts Generate Function */
if (!function_exists('startup_company_theme_google_fonts_generate')) {

function startup_company_theme_google_fonts_generate() {
	$cmsmasters_option = startup_company_get_global_options();
	...
	foreach (cmsmasters_google_fonts_list() as $key => $value) {
		if ( 
			(isset($cmsmasters_option['startup-company' . '_content_font_google_font']) && $key == $cmsmasters_option['startup-company' . '_content_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['startup-company' . '_link_font_google_font']) && $key == $cmsmasters_option['startup-company' . '_link_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['startup-company' . '_nav_title_font_google_font']) && $key == $cmsmasters_option['startup-company' . '_nav_title_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['startup-company' . '_nav_dropdown_font_google_font']) && $key == $cmsmasters_option['startup-company' . '_nav_dropdown_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['startup-company' . '_h1_font_google_font']) && $key == $cmsmasters_option['startup-company' . '_h1_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['startup-company' . '_h2_font_google_font']) && $key == $cmsmasters_option['startup-company' . '_h2_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['startup-company' . '_h3_font_google_font']) && $key == $cmsmasters_option['startup-company' . '_h3_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['startup-company' . '_h4_font_google_font']) && $key == $cmsmasters_option['startup-company' . '_h4_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['startup-company' . '_h5_font_google_font']) && $key == $cmsmasters_option['startup-company' . '_h5_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['startup-company' . '_h6_font_google_font']) && $key == $cmsmasters_option['startup-company' . '_h6_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['startup-company' . '_button_font_google_font']) && $key == $cmsmasters_option['startup-company' . '_button_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['startup-company' . '_small_font_google_font']) && $key == $cmsmasters_option['startup-company' . '_small_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['startup-company' . '_input_font_google_font']) && $key == $cmsmasters_option['startup-company' . '_input_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['startup-company' . '_quote_font_google_font']) && $key == $cmsmasters_option['startup-company' . '_quote_font_google_font'] && $key != '') 
		) {
			$keys[] = $key;
		}
	}
...
add_action('wp_enqueue_scripts', 'startup_company_theme_google_fonts_generate');
...
function startup_company_get_google_font($font) {
	if ($font != '') {
		if (strpos($font, ':')) {
...
function startup_company_the_widgets_init() {
    ...
    register_sidebar(
        array(
            'name' => esc_html__('Sidebar', 'startup-company'), 
            'id' => 'sidebar_default', 
            'description' => esc_html__('Widgets in this area will be shown in all left and right sidebars till you don\'t use custom sidebar.', 'startup-company'), 
    ...
    register_sidebar(
        array(
            'name' => esc_html__('Bottom Sidebar', 'startup-company'), 
            'id' => 'sidebar_bottom', 
            'description' => esc_html__('Widgets in this area will be shown at the bottom of middle block below the content and middle sidebar, but above footer.', 'startup-company'), 
            'before_widget' => '<aside id="%1$s" class="widget %2$s">', 
            'after_widget' => '</aside>', 
            'before_title' => '<h3 class="widgettitle">', 
            'after_title' => '</h3>'
    ...
    register_sidebar(
        array(
            'name' => esc_html__('Archive Sidebar', 'startup-company'), 
            'id' => 'sidebar_archive', 
            'description' => esc_html__('Widgets in this area will be shown in all left and right sidebars on archives pages.', 'startup-company'), 
            'before_widget' => '<aside id="%1$s" class="widget %2$s">', 
            'after_widget' => '</aside>', 
            'before_title' => '<h3 class="widgettitle">', 
            'after_title' => '</h3>'
    ...
    register_sidebar(
        array(
            'name' => esc_html__('Search Sidebar', 'startup-company'), 
            'id' => 'sidebar_search', 
            'description' => esc_html__('Widgets in this area will be shown in left or right sidebar on search page.', 'startup-company'), 
            'before_widget' => '<aside id="%1$s" class="widget %2$s">', 
            'after_widget' => '</aside>', 
            'before_title' => '<h3 class="widgettitle">', 
            'after_title' => '</h3>'
	...
	if (isset($cmsmasters_option['startup-company' . '_sidebar']) && sizeof($cmsmasters_option['startup-company' . '_sidebar']) > 0) {
		foreach ($cmsmasters_option['startup-company' . '_sidebar'] as $sidebar) {
			register_sidebar(array( 
				'name' => $sidebar, 
				'id' => generateSlug($sidebar, 45), 
				'description' => esc_html__('Custom sidebar created with cmsmasters admin panel.', 'startup-company'), 
				'before_widget' => '<aside id="%1$s" class="widget %2$s">', 
				'after_widget' => '</aside>', 
				'before_title' => '<h3 class="widgettitle">', 
				'after_title' => '</h3>' 
...
add_action('widgets_init', 'startup_company_the_widgets_init');



/* Register Showing Home Page on Default WordPress Pages Menu */
function startup_company_page_menu_args($args) {
    $args['show_home'] = true;
...
add_filter('wp_page_menu_args', 'startup_company_page_menu_args');
...
if (function_exists('add_theme_support')) {
	...
	function startup_company_add_post_type_support_project($post) {
	...
	add_action('load-post.php', 'startup_company_add_post_type_support_project');
	
	add_action('load-post-new.php', 'startup_company_add_post_type_support_project');
	
	
	// Add post-formats to post_type 'project'
	function startup_company_add_post_formats_to_project() {
		add_post_type_support('project', 'post-formats');
		
		register_taxonomy_for_object_type('post_format', 'project');
	}
	
	add_action('init', 'startup_company_add_post_formats_to_project', 11);
	...
	add_filter('image_size_names_choose', 'startup_company_select_image_size');
}



/* Add Image Thumbnails Size to the List */
function startup_company_select_image_size($sizes) {
	$thumbnail_list = cmsmasters_image_thumbnail_list();
...
function startup_company_add_editor_styles() {
...
add_action('init', 'startup_company_add_editor_styles');



/* Register Removing 'More Text' From Excerpt */
function startup_company_new_excerpt_more($more) {
	return '...';
}

add_filter('excerpt_more', 'startup_company_new_excerpt_more');
...
function startup_company_excerpt($length = 55, $show = true) {
	if ($show) {
...
function startup_company_post_author_archive($query) {
...
add_action('pre_get_posts', 'startup_company_post_author_archive');



/* Check Row p Wrapper */
function startup_company_rowcheck($content) {
...
function startup_company_generate_front_css() {
	$shortcodes_css = get_post_meta(get_the_ID(), 'cmsmasters_shortcodes_custom_css', true);
	
	
	wp_add_inline_style('startup-company-retina', $shortcodes_css);
}

add_action('wp_enqueue_scripts', 'startup_company_generate_front_css');
...
function startup_company_add_global_icons() {
	...
	if ($wp_filesystem) {
		...
		update_option('cmsmasters_' . 'startup-company' . '_icons', serialize($arr));
		
		update_option('cmsmasters_' . 'startup-company' . '_icons_custom', serialize($arr_custom));
	}
}
...
function cmsmasters_composer_icons() {
	...
	if ( 
		...
		$icons = get_option('cmsmasters_' . 'startup-company' . '_icons');
		
		$icons_custom = get_option('cmsmasters_' . 'startup-company' . '_icons_custom');
		...
		} elseif (wp_script_is('startup-company-lightbox-js', 'queue')) {
			wp_add_inline_script('startup-company-lightbox-js', $out, 'before');
		}
	}
}
...
function startup_company_regenerate_styles() {
	$custom_css_fonts = startup_company_theme_fonts();
	
	$custom_css_colors_primary = startup_company_theme_colors_primary();
	
	$custom_css_colors_secondary = startup_company_theme_colors_secondary();
	
	
	$custom_css = $custom_css_fonts . $custom_css_colors_primary . $custom_css_colors_secondary;
	
	
	startup_company_write_styles($custom_css);
}



/* Write Custom Styles to File Function */
function startup_company_write_styles($styles, $filename = '') {
	$upload_dir = wp_upload_dir();
	...
	$is_dir = startup_company_create_folder($style_dir);
	
	
	if ($is_dir === false) {
		update_option('cmsmasters_style_dir_writable_' . 'startup-company', 'false');
		
		update_option('cmsmasters_style_exists_' . 'startup-company', 'false');
	...
	$file = trailingslashit($style_dir) . (($filename != '') ? $filename : 'startup-company') . '.css';
	
	
	$created = startup_company_create_file($file, $styles);
	
	
	if ($created === true) {
		update_option('cmsmasters_style_dir_writable_' . 'startup-company', 'true');
		
		update_option('cmsmasters_style_exists_' . 'startup-company', 'true');
	}
}
...
function startup_company_create_folder(&$folder, $addindex = true) {
...
function startup_company_create_file($file, $content = '', $verifycontent = true) {
	global $wp_filesystem;
...
function cmsmasters_get_tweets($username, $count) {
	...
	$numTweets = $count;
	$cacheTime = 1;
	$backupName = 'cmsmasters_' . 'startup-company' . '_tweets_list_backup';
	
	
	$connection = new TwitterOAuth( 
		(($cmsmasters_option['startup-company' . '_api_key'] != '') ? $cmsmasters_option['startup-company' . '_api_key'] : ''), 
		(($cmsmasters_option['startup-company' . '_api_secret'] != '') ? $cmsmasters_option['startup-company' . '_api_secret'] : ''), 
		(($cmsmasters_option['startup-company' . '_access_token'] != '') ? $cmsmasters_option['startup-company' . '_access_token'] : ''), 
		(($cmsmasters_option['startup-company' . '_access_token_secret'] != '') ? $cmsmasters_option['startup-company' . '_access_token_secret'] : '')
	);
...
function startup_company_sidebarDefaultText() {
	...
	'<aside id="archives" class="widget widget_archive">' . "\n" . 
		'<h3 class="widgettitle">' . esc_html__('Archives', 'startup-company') . '</h3>' . "\n" . 
		'<ul>' . "\n";
	...
	'<aside id="meta" class="widget widget_meta">' . "\n" . 
		'<h3 class="widgettitle">' . esc_html__('Meta', 'startup-company') . '</h3>' . "\n" . 
		'<ul>' . "\n\t";
	...
	echo '" title="' . esc_attr__('Syndicate this site using RSS 2.0', 'startup-company') . '">' . esc_html__('Entries', 'startup-company') . ' ' . 
			'<abbr title="' . esc_attr__('Really Simple Syndication', 'startup-company') . '">' . esc_html__('RSS', 'startup-company') . '</abbr>' . 
		'</a>' . 
	'</li>' . "\n\t" . 
	'<li>' . 
		'<a href="';
	...
	echo '" title="' . esc_attr__('The latest comments to all posts in RSS', 'startup-company') . '">' . esc_html__('Comments', 'startup-company') . ' ' . 
					'<abbr title="' . esc_attr__('Really Simple Syndication', 'startup-company') . '">' . esc_html__('RSS', 'startup-company') . '</abbr>' . 
				'</a>' . 
			'</li>' . "\n\t" . 
			'<li>' . 
				'<a href="http://wordpress.org/" title="' . esc_attr__('Powered by WordPress, state-of-the-art semantic personal publishing platform.', 'startup-company') . '">WordPress.org</a>' . 
			'</li>' . "\r" . 
		'</ul>' . "\n" . 
	'</aside>' . "\n";
}
...
function startup_company_theme_bg_styles() {
	global $post;
	...
	if ($cmsmasters_option['startup-company' . '_theme_layout'] == 'boxed') {
		...
		if ($cmsmasters_bg_default == 'false') {
			...
			$cmsmasters_bg_col = $cmsmasters_option['startup-company' . '_bg_col'];
			$cmsmasters_bg_img_enable = $cmsmasters_option['startup-company' . '_bg_img_enable'];
			$cmsmasters_bg_img_str = $cmsmasters_option['startup-company' . '_bg_img'];
			$cmsmasters_bg_pos = $cmsmasters_option['startup-company' . '_bg_pos'];
			$cmsmasters_bg_rep = $cmsmasters_option['startup-company' . '_bg_rep'];
			$cmsmasters_bg_att = $cmsmasters_option['startup-company' . '_bg_att'];
			$cmsmasters_bg_size = $cmsmasters_option['startup-company' . '_bg_size'];
		}
	...
	wp_add_inline_style('startup-company-style', $out);
}

add_action('wp_enqueue_scripts', 'startup_company_theme_bg_styles');



/* Get Logo Function */
function startup_company_logo() {
	$cmsmasters_option = startup_company_get_global_options();
	
	
	if ($cmsmasters_option['startup-company' . '_logo_type'] == 'text') {
		if ($cmsmasters_option['startup-company' . '_logo_title'] != '') {
			$blog_title = $cmsmasters_option['startup-company' . '_logo_title'];
		} else {
			$blog_title = (get_bloginfo('name')) ? get_bloginfo('name') : 'Startup Company';
		}
		
		
		if ($cmsmasters_option['startup-company' . '_logo_subtitle'] != '') {
			$blog_descr = $cmsmasters_option['startup-company' . '_logo_subtitle'];
		} else {
			$blog_descr = (get_bloginfo('description')) ? get_bloginfo('description') : esc_html__('Default Logo Subtitle', 'startup-company');
		}
		...
		echo '<a href="' . esc_url(home_url('/')) . '" title="' . esc_attr($blog_title) . '" class="logo">' . "\n\t" . 
			'<span class="logo_text_wrap">' . 
				...
				($cmsmasters_option['startup-company' . '_logo_subtitle'] ? '<span class="title_text">' . esc_html($blog_descr) . '</span>' : '') . 
			'</span>' . 
		'</a>';
	} else {
		...
		if ($cmsmasters_option['startup-company' . '_logo_url'] == '') {
			...
			$logo_img = explode('|', $cmsmasters_option['startup-company' . '_logo_url']);
			...
			if ($cmsmasters_option['startup-company' . '_logo_url_retina'] != '') {
				$logo_img_retina = explode('|', $cmsmasters_option['startup-company' . '_logo_url_retina']);
...
/* Logo Styles */
function startup_company_theme_logo_styles() {
	$cmsmasters_option = startup_company_get_global_options();
	...
	if ($cmsmasters_option['startup-company' . '_logo_type'] == 'text') {
		if ($cmsmasters_option['startup-company' . '_logo_custom_color']) {
			$out .= "
				#header a.logo span.title {
					" . cmsmasters_color_css('color', $cmsmasters_option['startup-company' . '_logo_title_color']) . "
				}
				
				#header a.logo span.title_text {
					" . cmsmasters_color_css('color', $cmsmasters_option['startup-company' . '_logo_subtitle_color']) . "
				}
			";
		}
	} else {
		...
		$header_mid_height = (($cmsmasters_option['startup-company' . '_header_mid_height'] !== '') ? $cmsmasters_option['startup-company' . '_header_mid_height'] : $defaults[$tab]['startup-company' . '_header_mid_height']);
...
add_action('wp_enqueue_scripts', 'startup_company_theme_logo_styles');



/* Get Footer Logo Function */
function startup_company_footer_logo($cmsmasters_option) {
	...
	if ($cmsmasters_option['startup-company' . '_footer_logo_url'] == '') {
		...
		$footer_logo_img = explode('|', $cmsmasters_option['startup-company' . '_footer_logo_url']);
		...
		if ($cmsmasters_option['startup-company' . '_footer_logo_url_retina'] != '') {
			$footer_logo_img_retina = explode('|', $cmsmasters_option['startup-company' . '_footer_logo_url_retina']);
...
function startup_company_social_icons() {
	$out = '';
...
<div class=\"social_wrap\">
	<div class=\"social_wrap_inner\">
		...
		foreach ($cmsmasters_option['startup-company' . '_social_icons'] as $cmsmasters_social_icons) {
...
function startup_company_get_comments($class = false, $show = false, $add_html = false) { 
	$out = '';
	
	if ($add_html) {
		$text = (get_comments_number() == '1') ? esc_html__('comment', 'startup-company') : esc_html__('comments', 'startup-company');
	} else {
		$text = '';
	}
	...
	if (comments_open()) {
		$out .= '<span class="cmsmasters_comments' . ($class ? ' ' . $class : '') . '">' . 
			'<a class="cmsmasters_theme_icon_comment" href="' . esc_url(get_comments_link()) . '" title="' . esc_attr__('Comment on', 'startup-company') . ' ' . esc_attr(get_the_title()) . '">' . 
...
/* Get Category List */
function startup_company_get_the_category_list($cmsmasters_id, $taxonomy, $sep = '', $before = '', $after = '', $taxonomy_class = false) {
...
function startup_company_theme_page_layout_scheme() {
	$cmsmasters_option = startup_company_get_global_options();
	...
	} elseif (CMSMASTERS_TRIBE_EVENTS && tribe_is_event_query() && isset($cmsmasters_option['startup-company' . '_events_layout'])) {
		$cmsmasters_layout = $cmsmasters_option['startup-company' . '_events_layout'];
	} elseif (is_archive() || is_home()) {
		$cmsmasters_layout = $cmsmasters_option['startup-company' . '_archives_layout'];
	} elseif (is_search()) {
		$cmsmasters_layout = $cmsmasters_option['startup-company' . '_search_layout'];
	} else {
		$cmsmasters_layout = $cmsmasters_option['startup-company' . '_other_layout'];
	}
	
	
	if ($cmsmasters_layout == '') {
		$cmsmasters_layout = $cmsmasters_option['startup-company' . '_layout'];
	}
...
function startup_company_global_shortcodes_styles_move($content) {
	return preg_replace("/(?<!['\"])<style.*?>([^`]*?)<\/style>/", '', $content);
}


function startup_company_row_checker($data) {
	$out = startup_company_rowcheck($data);
	
	return $out;
}

add_filter('the_content', 'startup_company_row_checker', 10, 2);
	...
	if( wp_verify_nonce($nonce, 'cmsmasters_ajax_like-nonce') ){
		...
		if ($post_ID != '') {
			...
			if (isset($_COOKIE['like-' . $post_ID]) || count($ipCheck) != 0) {
				...
				if ($add_html == 'true') {
					$text = ($plusLike == '1') ? esc_html__('like', 'startup-company') : esc_html__('likes', 'startup-company');
				} else {
					$text = '';
				}
...
function cmsmasters_ajax_apply_theme_style_callback() {
	...
	if (wp_verify_nonce($nonce, 'cmsmasters_ajax_apply_theme_style-nonce')) {
		if (isset($_POST['theme_style'])) {
			update_option('cmsmasters_startup-company_theme_style', $_POST['theme_style']);
		}
...
function startup_company_theme_style_change() {
	if (get_option('cmsmasters_options_startup-company' . CMSMASTERS_THEME_STYLE . '_theme_style')) {
		return;
	} else {
		startup_company_add_global_options();
		
		startup_company_add_global_icons();
		
		startup_company_regenerate_styles();
	}
}

add_action('init', 'startup_company_theme_style_change');
...
function cmsmasters_ajax_reset_settings_callback() {
	...
	if (wp_verify_nonce($nonce, 'cmsmasters_ajax_reset_settings-nonce')) {
		startup_company_add_global_options(true);
...
function cmsmasters_ajax_export_settings_callback() {
	...
	if (wp_verify_nonce($nonce, 'cmsmasters_ajax_export_settings-nonce')) {
		$cmsmasters_global_settings = array( 
			'cmsmasters_options_' . 'startup-company' . CMSMASTERS_THEME_STYLE . '_general', 
			'cmsmasters_options_' . 'startup-company' . CMSMASTERS_THEME_STYLE . '_bg', 
			'cmsmasters_options_' . 'startup-company' . CMSMASTERS_THEME_STYLE . '_header', 
			'cmsmasters_options_' . 'startup-company' . CMSMASTERS_THEME_STYLE . '_content', 
			'cmsmasters_options_' . 'startup-company' . CMSMASTERS_THEME_STYLE . '_footer', 
			'cmsmasters_options_' . 'startup-company' . CMSMASTERS_THEME_STYLE . '_font_content', 
			'cmsmasters_options_' . 'startup-company' . CMSMASTERS_THEME_STYLE . '_font_link', 
			'cmsmasters_options_' . 'startup-company' . CMSMASTERS_THEME_STYLE . '_font_nav', 
			'cmsmasters_options_' . 'startup-company' . CMSMASTERS_THEME_STYLE . '_font_heading', 
			'cmsmasters_options_' . 'startup-company' . CMSMASTERS_THEME_STYLE . '_font_other', 
			'cmsmasters_options_' . 'startup-company' . CMSMASTERS_THEME_STYLE . '_element_sidebar', 
			'cmsmasters_options_' . 'startup-company' . CMSMASTERS_THEME_STYLE . '_element_icon', 
			'cmsmasters_options_' . 'startup-company' . CMSMASTERS_THEME_STYLE . '_element_lightbox', 
			'cmsmasters_options_' . 'startup-company' . CMSMASTERS_THEME_STYLE . '_element_sitemap', 
			'cmsmasters_options_' . 'startup-company' . CMSMASTERS_THEME_STYLE . '_element_error', 
			'cmsmasters_options_' . 'startup-company' . CMSMASTERS_THEME_STYLE . '_element_code', 
			'cmsmasters_options_' . 'startup-company' . CMSMASTERS_THEME_STYLE . '_element_recaptcha', 
			'cmsmasters_options_' . 'startup-company' . CMSMASTERS_THEME_STYLE . '_single_post', 
			'cmsmasters_options_' . 'startup-company' . CMSMASTERS_THEME_STYLE . '_single_project', 
			'cmsmasters_options_' . 'startup-company' . CMSMASTERS_THEME_STYLE . '_single_profile'
		);
		...
		foreach (startup_company_all_color_schemes_list() as $key => $value) {
			$cmsmasters_global_colors[] = 'cmsmasters_options_' . 'startup-company' . CMSMASTERS_THEME_STYLE . '_color_' . $key;
		}
