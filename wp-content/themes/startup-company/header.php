...
<?php startup_company_get_header_search_form($cmsmasters_option); ?>

<!-- _________________________ Start Page _________________________ -->
<div id="page" class="<?php startup_company_get_page_classes($cmsmasters_option); ?>hfeed site">
...
<div id="middle">
<?php 
startup_company_page_heading();


list($cmsmasters_layout, $cmsmasters_page_scheme) = startup_company_theme_page_layout_scheme();
