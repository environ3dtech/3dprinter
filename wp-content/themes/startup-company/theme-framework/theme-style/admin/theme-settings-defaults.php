...
function startup_company_settings_general_defaults($id = false) {
	$settings = array( 
		'general' => array( 
			...
			'startup-company' . '_logo_url' => 				'|' . get_template_directory_uri() . '/theme-framework/theme-style' . CMSMASTERS_THEME_STYLE . '/img/logo.png', 
			'startup-company' . '_logo_url_retina' => 		'|' . get_template_directory_uri() . '/theme-framework/theme-style' . CMSMASTERS_THEME_STYLE . '/img/logo_retina.png', 
		...
		'content' => array( 
			...
			'startup-company' . '_archives_layout' => 			'r_sidebar', 
			'startup-company' . '_search_layout' => 			'r_sidebar', 
			...
			'startup-company' . '_heading_bg_image' => 			'|' . get_template_directory_uri() . '/theme-framework/theme-style' . CMSMASTERS_THEME_STYLE . '/img/headline_bg.jpg', 
		...
		'footer' => array( 
			...
			'startup-company' . '_footer_logo_url' => 				'|' . get_template_directory_uri() . '/theme-framework/theme-style' . CMSMASTERS_THEME_STYLE . '/img/logo_footer.png', 
			'startup-company' . '_footer_logo_url_retina' => 		'|' . get_template_directory_uri() . '/theme-framework/theme-style' . CMSMASTERS_THEME_STYLE . '/img/logo_footer_retina.png', 
...
/* Add Google Font */
if (!function_exists('startup_company_add_foogle_font')) {

function startup_company_add_foogle_font($fonts) {
	$fonts_new = array();
...
add_filter('startup_company_google_fonts_list_filter', 'startup_company_add_foogle_font');
