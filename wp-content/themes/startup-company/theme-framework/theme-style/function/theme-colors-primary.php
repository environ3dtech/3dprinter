...
function startup_company_theme_colors_primary() {
...
/***************** Start {$title} Color Scheme Rules ******************/
	...
	{$rule}.cmsmasters_open_project .owl-buttons > div > span > span:before {
		" . cmsmasters_color_css('color', $cmsmasters_option['startup-company' . '_' . $scheme . '_link']) . "
	}
	...
	{$rule}.cmsmasters_header_search_form {
		background-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['startup-company' . '_' . $scheme . '_link']) . ", .95);
	}
	
	{$rule}.cmsmasters_profile_horizontal .cmsmasters_img_social_wrap .profile_social_icons {
		background-color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['startup-company' . '_' . $scheme . '_link']) . ", .75);
	}
	...
	{$rule}.cmsmasters_open_post .cmsmasters_owl_slider .owl-pagination > div {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['startup-company' . '_' . $scheme . '_bg']) . "
	}
	...
	{$rule}.cmsmasters_stats.stats_mode_circles .cmsmasters_stat_wrap .cmsmasters_stat .cmsmasters_stat_inner {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['startup-company' . '_' . $scheme . '_alternate']) . "
	}
	...
	{$rule}.cmsmasters_open_post .cmsmasters_owl_slider .owl-pagination > div:hover,
	{$rule}.cmsmasters_open_post .cmsmasters_owl_slider .owl-pagination > div.active {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['startup-company' . '_' . $scheme . '_secondary']) . "
	}
	...
	/* Start Custom Rules */
	{$rule}::selection {
		" . cmsmasters_color_css('background', $cmsmasters_option['startup-company' . '_' . $scheme . '_secondary']) . "
		" . cmsmasters_color_css('color', $cmsmasters_option['startup-company' . '_' . $scheme . '_bg']) . ";
	}
	...
	if ($scheme != 'default') {
		...
		.cmsmasters_color_scheme_{$scheme}.cmsmasters_row_bot_zigzag:after {
			background-image: -webkit-linear-gradient(135deg, " . $cmsmasters_option['startup-company' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					-webkit-linear-gradient(45deg, " . $cmsmasters_option['startup-company' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
			background-image: -moz-linear-gradient(135deg, " . $cmsmasters_option['startup-company' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					-moz-linear-gradient(45deg, " . $cmsmasters_option['startup-company' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
			background-image: -ms-linear-gradient(135deg, " . $cmsmasters_option['startup-company' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					-ms-linear-gradient(45deg, " . $cmsmasters_option['startup-company' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
			background-image: -o-linear-gradient(135deg, " . $cmsmasters_option['startup-company' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					-o-linear-gradient(45deg, " . $cmsmasters_option['startup-company' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
			background-image: linear-gradient(315deg, " . $cmsmasters_option['startup-company' . '_' . $scheme . '_bg'] . " 25%, transparent 25%), 
					linear-gradient(45deg, " . $cmsmasters_option['startup-company' . '_' . $scheme . '_bg'] . " 25%, transparent 25%);
		}
		";
	}
...
/***************** Start {$title} Button Color Scheme Rules ******************/
	...
	{$rule}.cmsmasters_button.cmsmasters_but_icon_divider:after {
		" . cmsmasters_color_css('border-right-color', $cmsmasters_option['startup-company' . '_' . $scheme . '_bg']) . "
	}
...
";
	...
	return apply_filters('startup_company_theme_colors_primary_filter', $custom_css);
}
